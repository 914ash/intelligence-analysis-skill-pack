...
- Source: US Government, March 2009
- Format: machine-converted from the original PDF into Markdown for public-safe repository distribution
- Notes: formatting is normalized for readability; page boundaries are preserved
...
This primer highlights structured analytic techniquessome widely used in the private
sector and academia, some unique to the intelligence profession. It is not a
comprehensive overview of how intelligenc e officers conduct analysis. Rather, the
primer highlights how structured analytic te chniques can help one challenge judgments,
...
Selective Bibliography ............................................................................................... 40TABLE OF CONTENTS
...
Richards Heuer,
The Psychology of
Intelligence AnalysisTHE MIND-SET CHALLENGE
...
they involve multiple actorsincluding
nonstate entitiesthat can adapt and
...
interactive systems such as financial flows,
regional economies or the international
system as a whole are in flux.2
The first hurdle for analysts is identifying
...
shroud of secrecyand sometimes
deceptionthat state and nonstate actors
...
opportunities to warn. Cognitive and perceptual biases in
...
general and more specific domains.
These constructs strongly influence what
information analysts will acceptthat is,
...
existing mental models; and conflicting
...
Kent Centers Occasional Paper, Making Sense of
Transnational Threats , Vol. 3, No. 1, October 2004. 1



## Page 6

2Common Perceptual and Cognitive Biases
Perceptual Biases
...
information becomes available. Biases in Evaluating Evidence
...
have considerable expertise. Biases in Perceiving Causality
...
support these outcomes. Identifying indicators of change (or
signposts) that can reduce the chances
of surprise.
Incorporating findings derived from these
...
3Strategic Assumptions That Were Not Challenged
1941 World War II
...
still lacked sufficient air defenses to counter Israeli airpower.
A surprise Arab attack, even if repelled, could wound Israel psychologically and prompt
international calls for cease-fires and diplomatic negotiations.
...
they might refuse to fully acknowledge this to the UN to maintain Iraqs regional status,
...
5The analytic techniques in this primer
...
to understand and employsuch as
Brainstorming and Devils Advocacy.
...
thinking; and imaginative thinking HOW TO USE THESE TECHNIQUES
...
best accomplishes the specific task
...
any time prior to finalizing judgments,
to insure that the assessment does not
rest on flawed premises. Identifying
hidden assumptions can be one of the
most difficult challenges an analyst
faces, as they are ideas heldoften
unconsciouslyto be true and, therefore,
...
these forces actually fight?). In this case,
there was high uncertainty and depending
on what level of reliability one assumed,
the analyst could arrive at very different conclusions about a potential Soviet
...
circumstances that could surprise them. DIAGNOSTIC TECHNIQUES

## Page 12

8Key Assumptions Check: The 2002 DC Sniper Case
The outbreak of sniper shootings in the Washington, DC area in the fall of 2002 provides
a good example of how this technique could have been applied. After the initial flurry of
...
If law enforcement officials had conducted a Key Assumptions Check, they could have
...
white van. Highly likely (but not certain) given past precedent with
...
Possible, but not sufficient reason to exclude from
...
assumption, officials could have avoided prematurely narrowing down the potential pool
...
4. Refine the list of key assumptions to
...
might not hold. QUESTIONS TO ASK DURING THIS
PROCESS INCLUDE:
...
would it significantly alter the analytic
line? How?
...
10QUALITY OF INFORMATION CHECK
...
has been provided, it will be difficult
for analysts to assess the informations
validity and establish a confidence level in
an intelligence assessment.VALUE ADDED
A thorough review of information
sources provides analystsas well
as policymakerswith an accurate
assessment of what we know and what
we do not know. It is also an opportunity
to confirm that sources have been cited
...
understanding how much confidence
...
accuracy. Identify information sources that appear
...
identified and properly flagged for other
...
are likely to figure in future analytic
assessments.
...
Weapons of Mass Destruction. 4 Analysis of Competing Hypotheses (ACH),
...
judgments. An indicators list included in a finished product also allows the
...
13Tracking the Potential for Political Instability in a Foreign Country
Topics Indicators 1999 2000
III III IV III III
Government
CapacityQuality of leadership/organizational capabilities
...
Legitimacy of
RegimeBreadth and depth of political participation
...
Opposition
ActivityEthnic/religious discontent
...
Economic
FactorsWeakness of domestic economy/unemployment/
inflation
...
Environmental
IssuesExtent of environmental degradation
...
can challenge each others evaluation
...
unduly influenced by a first impression,
based on incomplete data, an existing
analytic line, or a single explanation that
seems to fit well enough. Analysts seldom generate a full set
...
picking the first solution that seems
...
inconsistent data. Prepare a matrix with hypotheses
...
hypothesesin some cases, analysts
...
matrix arrays each piece of evidence on the vertical axis and then evaluates each in terms of the items consistency
...
explanation.
WHEN TO USE
Devils Advocacy is most effective when
...
get wrong, Devils Advocacy can provide
further confidence that the current analytic
line will hold up to close scrutiny. An
individual analyst can often assume the
role of the Devils Advocate if he or she
has some doubts about a widely held
view, or a manager might designate a
courageous analyst to challenge the
prevailing wisdom in order to reaffirm the
groups confidence in those judgments.
...
scrutiny provided by Devils Advocacy.
VALUE ADDED
...
about their findings. The analyst could
...
is needed; or 3) some serious flaws in logic
...
or whether major gaps exist.CONTRARIAN TECHNIQUES

## Page 22

18 Highlight the evidence that could
support an alternative hypothesis or
contradicts the current thinking.
 Present to the group the findings
that demonstrate there are flawed
...
review uncovers major analytic flaws.  Be sure that any products generated
clearly lay out the conventional wisdom
and are identified as an explicitly
Devils Advocate project; otherwise,
the reader can become confused as to
the current official view on the issue.
...
from Devils Advocacy, where the purpose
...
that need to be clarified. Sometimes
...
views within an analytic office or
...
exercise requires a significant commitment
...
T eam A/T eam B. If those circumstances
...
Often senior officials can learn more by
weighing well-argued conflicting views than
...
that can confirm or disconfirm a range of
hypotheses.
...
20A Team A/Team B View: Chinas Military
A: Chinas Hollow Military
by Bates Gill and Michael OHanlonB: Chinas Military: A Second
...
The PRCs armed forces are not very good
...
a year on defense . . .. . . We think they got it half right. China
...
create an artificial and misleading
...
argument.Debate Phase. An oral presentation of
...
of the alternative team findings; this can
...
challenge the other teams arguments,
and rebut the opponents critique of its
case.
...
have benefited from considering the
...
23High Impact of a Low-Probability Event: Pearl Harbor
...
a confidently made forecast may not be
entirely justified. It is similar to a High-
Impact/Low-Probability analysis, but it
does not dwell on the consequences
of the event as much as it accepts
the significance and moves directly to
...
even unlikely onesmight enable such an
...
could causeor alterit, and likely
signposts that an event is imminent.
A What If? analysis can complement a
difficult judgment reached and provide
...
that an event remains unlikely. THE METHOD
...
concrete waysthat is, specifying what
...
25What If? Analysis: An Unlikely Outcome in Yugoslavia, 1990.
...
27IMAGINATIVE THINKING TECHNIQUES
BRAINSTORMING
...
about their issue.
Brainstorming, almost by definition,
...
have the benefit of others perspectives to
help develop the ideas as fully. Moreover,
an individual may have difficulty breaking
free of his or her cognitive biases without
the benefit of a diverse group.
VALUE ADDED
...
out ideas that seem farfetched, poorly sourced, or seemingly irrelevant to the
...
processthat is, someone who does not
...
28Brainstorming and Divergent Thinking:
...
Some notes may be moved several times as notes begin to cluster. Copying
...
or concepts identified or new areas
...
files and recode the data. With a modest
...
on familiar factors within their field or
analytic issue. That is, they think from the
insidenamely, what they controlout
...
profoundly affect the analysts own field or
issue. This technique encourages analysts
to get away from their immediate analytic
tasks (the so-called inbox) and think
about their issues in a wider conceptual and contextual framework. By recasting the
...
actor operating within the adversarys
...
different codes of behavior or motivations. Often this technique can introduce new or
different stimuli that might not have been
factored into traditional analysissuch as
the targets familial ties or the international
...
leader or group makes specific decisions,
proposes recommendations, or lays
out courses of actions. The more these
papers reflect the cultural and personal
...
32A Red Team Perspective
Irans Military Strategy Vis-a-vis the United States
...
33Red Team analysis is not easy to conduct.
It requires significant time to develop a
team of qualified experts who can think like
the adversary. The team has to distance
itself from the normal analysis and work
as though living in the targets world.
...
formatthat is, drafted as memos to or
from a leader or group. Red Team analysis avoids the use of
caveats or qualifications and assumes
...
give a prediction based on the targets
special personal, organizational, or
cultural experiences.

## Page 38

34ALTERNATIVE FUTURES ANALYSIS
...
challenge the analysts high confidence
...
rather than to predict one outcome. VALUE ADDED
...
among key actors that are difficult to
...
participants find the process of developing
such scenarios as useful as any finished
product that attempts to capture the results
of the exercise. Analysts and policymakers
can benefit from this technique in several
ways:
...
by different outcomes. The future is plural.
Peter Schwartz,
...
35
Hypothetical Threats to the Homeland:
Using Spectrums to Define Potential Targets
...
at shopping centers Mortar attack on US
militarys home base
 Sniper attacks on home
base Guard Post Information warfare
 Introduce contaminated
drugs into domestic
supply chain BW attack on military
base water supply
...
targets could include computer networks and domestic drug supplies. Having filled in a quadrant,
analysts can then turn to devising likely indicators or signposts of such a future.

## Page 40

36 It aids analysts and policymakers in
...
officials who are examining the general
topic.
...
most relevant endpoints assigned.  Establish the most relevant endpoints
...
38These structured analytic techniques
...
an analysts ability to keep an open mind,
to consider multipleincluding highly
unlikelyhypotheses, to challenge
conventional wisdom, and to assess the
impact of important information gaps or
deception on analytic judgments and
confidence levels. The Timeline for Using
Analytic Techniques provides some
thoughts on when to use one or more of
them during the course of an analysts
research and writing. S T R A T E G I E S F O R U S I N G S T R U C T U R E D
ANALYTIC TECHNIQUES
Starting Out
...
factors outside the lead analysts area
...
analysts understanding the prospects
for political stability in an oil-exporting
A Timeline for Using Analytic Techniques
Throughout an Analytic Project
Begin Paper/
Commence ProjectDeliver Final Paper/
Brief Key Findings
Brainstorming
Key Assumptions Check
What If? Analysis
High Impact/Low Probability Analysis
Outside-In ThinkingBrainstorming
Key Assumptions Check
Team A/Team B
Analysis/Debate
Red Team Red TeamDevils Advocacy
...
39S T R A T E G I E S F O R U S I N G S T R U C T U R E D
ANALYTIC TECHNIQUES
country or a underdeveloped country
entirely dependent on expensive energy
imports. A High Impact/Low Probability
assessment can also sensitize analysts
early on to the significance of dramatic
...
developed. If the assessment contains strong judgments about an adversarys
...
the analysts a better degree of confidence
in the information base and judgments
reached in the assessment.
A Final Check
As the assessment is being finalized,
...
a firm consensus has formed around an
analytic line and has not been seriously
questioned in some time, then a Devils
Advocacy exercise could be useful.
Analysts might also use a final review to
decide if they have identified a list of key
...
40SELECTIVE BIBLIOGRAPHY
Graham Allison, Essence of Decision : Explaining the Cuban Missile Crisis : Examines
the Kennedy Administrations decisionmaking style from alternative perspectives of the
...
and the Middle East.
Josh Epstein and Rob Axtell, Sugarscape: Creating Artificial Societies from the Ground
Up. Develops a very simple agent-based model of a silicon-based society and then does
simulations of various social, economic and political phenomena, including conflict.
...
Gary Klein, Intuition At Work . Shows how developing ones intuition can improve your
